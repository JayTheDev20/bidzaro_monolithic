...
### 3. Calculate Potential Points
**GET** `/loyalty/calculate?orderAmount=10000.00`
...
### 4. Get All Open Tickets (Admin/Support)
**GET** `/support/admin/tickets?page=0&size=20`
...
### 5. Get My Assigned Tickets (Admin/Support)
**GET** `/support/admin/my-tickets?page=0&size=20`
...
```json
{
  ...
  "data": [
    {
      "ticketId": "ticket_2",
      "subject": "Order cancellation query",
      "status": "IN_PROGRESS"
    }
  ]
}
...
### 6. Assign Ticket (Admin/Support)
**POST** `/support/admin/tickets/{ticketId}/assign?agentId=agent_123`
...
### 7. Update Ticket Status (Admin/Support)
**PATCH** `/support/admin/tickets/{ticketId}/status?status=IN_PROGRESS`
...
### 8. Resolve Ticket (Admin/Support)
**POST** `/support/admin/tickets/{ticketId}/resolve?resolutionNotes=Issue fixed`
...
### 9. Rate Ticket
**POST** `/support/tickets/{ticketId}/rate?rating=5&feedback=Great support!`
...
### 2. Add to Wishlist
**POST** `/wishlist/items?vendorItemId=vendor_item_123`
...
```json
{
  ...
  "data": {
    "conversationId": "conv_1",
    "participants": ["user_123456", "vendor_123"],
    "type": "USER_VENDOR",
...
**POST** `/chat/conversations?otherUserId=vendor_123&type=USER_VENDOR`
  ...
  "data": [
    {
      ...
      "content": "Hi, I need catering for 500 people",
      "messageType": "TEXT",
...
### 5. Send Message
**POST** `/chat/messages?conversationId=conv_1&content=What is your availability?&messageType=TEXT`
...
```json
{
  ...
  "data": {
    "messageId": "msg_2",
    "conversationId": "conv_1",
    "content": "What is your availability?",
